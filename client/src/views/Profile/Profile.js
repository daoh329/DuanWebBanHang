              ...
              >
                <div className="teko-card css-jjszbd">
                  <div className="teko-card-body css-0">
                    ...
                    {/* form */}
                    <form>
                      <div name="name" className="css-1umbfo7">
                        <div className="form-input__label css-1270aei">
                          Họ tên
                        </div>
                        {/* input tên */}
                        <input
                          name="name"
                          className="form-input__input css-90j4a3"
                        />
                      </div>
                      <div name="email" className="css-1umbfo7">
                        <div className="form-input__label css-1270aei">
                          Email
                        </div>
                        {/* input email */}
                      ...
                      <div name="telephone" value="" className="css-1umbfo7">
                        <div className="form-input__label css-1270aei">
                          Số điện thoại
                        </div>
                        {/* input sdt */}
                    ...
                    <div className="css-1x6y1s9"></div>
                  </div>
                </div>
              </div>
              <div
                className="teko-col teko-col-4 css-gr7r8o style-qo2KB"
                id="style-qo2KB"
              >
                <div className="teko-card css-jjszbd">
                  <div className="teko-card-body css-0">
                    ...
                    <a
                      ...
                      className="css-16ptmp8"
                      color="link500"
                    >
                      <svg
                        fill="none"
                        viewBox="0 0 24 24"
                        className="css-zzrru3"
                        color="link500"
                        height="1em"
                        width="1em"
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <div type="body" color="link500" className="css-4mmgnd">
