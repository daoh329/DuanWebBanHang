...
<div className="css-18c0ysw snipcss0-4-4-52">
  ...
  <div className="css-1xehz2l snipcss0-1-1-2">
    <div className="css-au5p93 snipcss0-2-2-3">Chọn khu vực nhận hàng</div>
    <div className="css-q55v4i snipcss0-2-2-4">
      <div className="css-12bxpw5 snipcss0-3-4-5">
        <div className="css-en0qru snipcss0-4-5-6" tabIndex={0}>
          <button type="button" className="css-ff84vc snipcss0-5-6-7">
        ...
        <div
          ...
          id="style-F8tYz"
        >
          <div origin="center top" className="css-1x7vo2d snipcss0-5-11-12">
            <ul className="css-1ymolov snipcss0-6-12-13">
              ...
              <li className="css-zsmsql snipcss0-7-13-16">Tỉnh Nghệ An</li>
              <li className="css-zsmsql snipcss0-7-13-17">
                Tỉnh Thừa Thiên Huế
              </li>
              <li className="css-zsmsql snipcss0-7-13-18">Tỉnh Long An</li>
              <li className="css-ip2e5w snipcss0-7-13-19">
                Thành phố Hồ Chí Minh
              </li>
              <li className="css-zsmsql snipcss0-7-13-20">Thành phố Cần Thơ</li>
              <li className="css-zsmsql snipcss0-7-13-21">Tỉnh Bình Dương</li>
              <li className="css-zsmsql snipcss0-7-13-22">Thành phố Hà Nội</li>
              <li className="css-zsmsql snipcss0-7-13-23">Tỉnh Đồng Nai</li>
              <li className="css-zsmsql snipcss0-7-13-24">Tỉnh Đắk Lắk</li>
              <li className="css-zsmsql snipcss0-7-13-25">Tỉnh Bắc Ninh</li>
              <li className="css-zsmsql snipcss0-7-13-26">Tỉnh Tây Ninh</li>
              <li className="css-zsmsql snipcss0-7-13-27">Tỉnh Tiền Giang</li>
              <li className="css-zsmsql snipcss0-7-13-28">Tỉnh Quảng Trị</li>
              <li className="css-zsmsql snipcss0-7-13-29">Tỉnh Thanh Hóa</li>
              <li className="css-zsmsql snipcss0-7-13-30">Tỉnh Bến Tre</li>
              <li className="css-zsmsql snipcss0-7-13-31">Tỉnh Ninh Thuận</li>
              <li className="css-zsmsql snipcss0-7-13-32">Tỉnh Khánh Hòa</li>
              <li className="css-zsmsql snipcss0-7-13-33">Tỉnh Đồng Tháp</li>
            </ul>
          </div>
          <div className="snipcss0-5-11-34 style-V8nJR" id="style-V8nJR"></div>
        </div>
      </div>
    </div>
  </div>
          ...
          <div className="css-un3w91 snipcss0-5-38-39">
            ...
            <div className="active css-1yyu6fw snipcss0-6-39-44">
              ...
              <p className="css-j662fd snipcss0-8-45-46">
                ĐỊA ĐIỂM KINH DOANH 6 - CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ
                PHONG VŨ - 02873096867
              </p>
              Số 2A, Nguyễn Oanh, Phường 7, Quận Gò Vấp, Thành phố Hồ Chí Minh,
          ...
          <div className="css-un3w91 snipcss0-5-49-50">
            ...
            <div className="css-1yyu6fw snipcss0-6-50-55">
              ...
              <p className="css-j662fd snipcss0-8-56-57">
                ĐỊA ĐIỂM KINH DOANH 1 - CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ
                PHONG VŨ - 02873016867
              </p>
              264A-264B-264C, Nguyễn Thị Minh Khai, Phường 6, Quận 3, Thành phố
              Hồ Chí Minh, Phường Võ Thị Sáu, Quận 3, Thành phố Hồ Chí Minh
              <p></p>
            </div>
          </div>
          ...
          <div className="css-un3w91 snipcss0-5-60-61">
            ...
            <div className="css-1yyu6fw snipcss0-6-61-66">
              ...
              <p className="css-j662fd snipcss0-8-67-68">
                ĐỊA ĐIỂM KINH DOANH 50 - CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ
                PHONG VŨ - 02873066867
              </p>
              677/2A Điện Biên Phủ, Phường 25, Quận Bình Thạnh, TP. HCM, Phường
          ...
          <div className="css-un3w91 snipcss0-5-71-72">
            ...
            <div className="css-1yyu6fw snipcss0-6-72-77">
              ...
              <p className="css-j662fd snipcss0-8-78-79">
                ĐỊA ĐIỂM KINH DOANH 3 - CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ
                PHONG VŨ - 02873036867
              </p>
              1081C, Hậu Giang, Phường 11, Quận 6, Thành phố Hồ Chí Minh, Phường
              11, Quận 6, Thành phố Hồ Chí Minh
              <p></p>
            </div>
          </div>
          ...
          <div className="css-un3w91 snipcss0-5-82-83">
            ...
            <div className="css-1yyu6fw snipcss0-6-83-88">
              ...
              <p className="css-j662fd snipcss0-8-89-90">
                Địa điểm Kinh doanh 4 - Công Ty Cổ Phần Thương Mại Dịch Vụ Phong
                Vũ - 02873046867
              </p>
              164, Lê Văn Việt, Tăng Nhơn Phú B, TP.Thủ Đức, Phường Tăng Nhơn
              Phú B, Thành phố Thủ Đức, Thành phố Hồ Chí Minh
              <p></p>
            </div>
          </div>
          ...
          <div className="css-un3w91 snipcss0-5-93-94">
            ...
            <div className="css-1yyu6fw snipcss0-6-94-99">
              ...
              <p className="css-j662fd snipcss0-8-100-101">
                ĐỊA ĐIỂM KINH DOANH 39 - CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ
                PHONG VŨ
              </p>
              292/15 Cách Mạng Tháng 8, Phường 10, Quận 3, Thành phố Hồ Chí Minh
              <p></p>
            </div>
          </div>
          ...
          <div className="css-un3w91 snipcss0-5-104-105">
            ...
            <div className="css-1yyu6fw snipcss0-6-105-110">
              ...
              <p className="css-j662fd snipcss0-8-111-112">
                Địa điểm kinh doanh 48 - Công ty cổ phần Thương mại - Dịch vụ
                Phong Vũ - 02873026867
              </p>
              Số 2, Đường Hoàng Hoa Thám, Phương 12, , Quận Tân Bình, Thành phố
              Hồ Chí Minh, Phường 12, Quận Tân Bình, Thành phố Hồ Chí Minh
              <p></p>
            </div>
          </div>
          ...
          <div className="css-un3w91 snipcss0-5-115-116">
            ...
            <div className="css-1yyu6fw snipcss0-6-116-121">
              ...
              <p className="css-j662fd snipcss0-8-122-123">
                ĐỊA ĐIỂM KINH DOANH 5 - CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ
                PHONG VŨ - 02873056867
              </p>
              Số 9 - 11, Nguyễn Thị Thập, Phường Tân Phú, Quận 7, Thành phố Hồ
              Chí Minh, Phường Tân Phú, Quận 7, Thành phố Hồ Chí Minh
              <p></p>
            </div>
          </div>
...
<div style={{display:'inline-grid'}}>
  ...
  <label>
    Tên khách hàng
    <Input placeholder="Tên khách hàng" allowClear onChange={onChange} />
  </label>
  <label>
    Số điện thoại
       ...
       <div
              ...
              >
                ...
                >
                  ...
                  >
                    Thanh toán qua Internet Banking, Visa, Master, JCB, VNPAY-QR q
                  </div>
                </div>
              </div>
              <div
