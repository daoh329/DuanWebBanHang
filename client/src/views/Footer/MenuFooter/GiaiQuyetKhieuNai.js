        ...
        <div className="view_manYY blockWrapper_8BIg7 noneVertical_jpmaI autoHorizontal_dqmM-">
          ...
          >
            <div className="css-175oi2r r-1ro0kt6 r-16y2uox r-1wbh5a2">
              <div className="view_manYY relative_F68jE column_C3yiR xlargeTop_38ZbM largeBottom_v1r32">
                <div className="view_manYY row_PhhRi justifySpaceBetween_js4s1 alignCenter_zl3iW">
                  <div className="css-175oi2r r-18u37iz r-1ro0kt6 r-16y2uox r-1wbh5a2">
                    <div
                ...
                <div className="view_manYY row_PhhRi justifySpaceBetween_js4s1 alignCenter_zl3iW">
                  <div className="css-175oi2r r-1wzrnnt r-1ro0kt6 r-16y2uox r-1wbh5a2"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div data-rnwrdesktop-1uwte3a="true" className="css-175oi2r">
          <div className="css-175oi2r r-bnwqim">
            <div
              ...
              data-document-key="f3dfad87cf1c4a558aa76d52ee0ee0fd"
              data-key="f3dfad87cf1c4a558aa76d52ee0ee0fd"
              autoCorrect="on"
              spellCheck="true"
              id="style-M7kco"
              className="style-M7kco"
            >
                              ...
                              >
                                ...
                                >
                                  <div
                                    ...
                                    data-key="c7b664c150c54cf3ac801c27f8aafd36"
                                  >
                                    <div>
                                      <div className="css-175oi2r r-1awozwy r-1ro0kt6 r-16y2uox r-1wbh5a2">
                                        <div
                                          className="css-175oi2r r-z2wwpe r-bnwqim style-H6Xpn"
                                          id="style-H6Xpn"
                                        >
                                          <div
                                            data-rnwi-5xr8s6-dse9kg-2fw26j-16zom3r-focus-visible="true"
                                            data-rnwi-handle="nearest"
                                            tabIndex={0}
                                            className="css-175oi2r r-1i6wzkk r-lrvibr r-1loqt21 r-1otgn73 r-1awozwy style-TbaaV"
                                            id="style-TbaaV"
                                          >
                                            <img
                                              alt=""
                                              src="https://DinhMinh/landing/wp-content/uploads/2019/11/tienmat400.png"
                                              width="100%"
                                              height="auto"
                                              decoding="async"
                              ...
                              >
                                ...
                                >
                                  <div style={{ marginLeft: "30px" }}>
                                    <p >
                                      Đình Minh có trách nhiệm tiếp nhận và xử lý khiếu nại của khách hàng liên quan đến giao dịch tại website DinhMinh
                                    </p>
                                    <p >
                                      - Khách hàng có quyền gửi khiếu nại về việc chất lượng, dịch vụ, giá cả sản phẩm không đúng với mô tả,
                                      thông tin thanh toán bị tiết lộ gây thiệt hại cho mình đến Ban quản trị của Đình Minh. Khi tiếp nhận những phản hồi này,
                                      Đình Minh sẽ xác nhận lại thông tin, trường hợp đúng như phản ánh của khách hàng tùy theo mức độ, Đình Minh sẽ có những biện pháp xử lý kịp thời.
                                    </p>
                                    <p>
                                      Khách hàng gửi khiếu nại tại địa chỉ :
                                    </p>
                                    <p>
                                      Tên tổ chức:<a style={{ color: 'red' }}> CÔNG TY CỔ PHẦN THƯƠNG MẠI - DỊCH VỤ ĐÌNH MINH</a>
                                    </p>
                                    <p>
                                      Trụ sở chính:  300/6 Hà Huy Tập, Tổ dân phố 8, Phường Tân An, Buon Ma Thuot, Vietnam
                                    </p>
                                    <p>
                                      Email: cskh@dinhminh.com
                                    </p>
                                    <p>
                                      Điện thoại: 0338112099
                                    </p>
                                  </div>
                    ...
                    >
                      <div className="css-175oi2r r-1ro0kt6 r-16y2uox r-1wbh5a2">
                        <div className="css-175oi2r">
                          <div className="css-175oi2r">
                            <div
                              data-key="bae1b15255fd49a490e4a6971bbf9f63"
                              className="view_manYY relative_F68jE column_C3yiR mediumVertical_-Vaii largeTop_ejwCW smallBottom_BmSGf"
                            >
                              <div
                                data-block-content="bae1b15255fd49a490e4a6971bbf9f63"
                                className="r-1oszu61 r-1xc7w19 r-1phboty r-1yadl64 r-deolkf r-6koalj r-eqz5dr r-crgep1 r-ifefl9 r-bcqeeo r-t60dpp r-bnwqim r-417010 r-1ro0kt6 r-16y2uox r-1wbh5a2"
                              >
                                <h2
                                  className="r-1xc7w19 r-1phboty r-1yadl64 r-deolkf r-6koalj r-1mlwlqe r-1q142lx r-crgep1 r-ifefl9 r-bcqeeo r-t60dpp r-bnwqim r-417010 r-18u37iz r-obd0qt"
                                  id="thanh-toan-quet-ma-vnpay-qr"
                                >
                                  <div
                                    dir="auto"
                                    data-rnwrdesktop-gg6oyi-1x35g6-37tt59-b88u0q="true"
                                    data-rnwr700-gg6oyi-adyw6z-135wba7-b88u0q="true"
                                    className="css-1rynq56 r-1nf4jbm r-fdjqy7 r-1xnzce8"
                                    id="text-thanh-toan-quet-ma-vnpay-qr"
                                  >
                                    ...
                                    <a
                                      href="#thanh-toan-quet-ma-vnpay-qr"
                                      aria-label="Direct link to heading"
                                      data-rnwi-1rasi3h-="true"
                                      data-rnwi--1loepla-hover-focus="true"
                                      data-rnwi-5xr8s6-dse9kg-2fw26j-16zom3r-focus-visible="true"
                    ...
                    >
                      <div className="css-175oi2r r-1ro0kt6 r-16y2uox r-1wbh5a2">
                        <div className="css-175oi2r">
                          <div className="css-175oi2r">
                            <div
                              data-key="2da88729782b47239eb2092d7371c55f"
                              className="view_manYY relative_F68jE column_C3yiR mediumVertical_-Vaii mediumTop_QDiZG mediumBottom_jdYUb"
                            >
                              <div
                                data-block-content="2da88729782b47239eb2092d7371c55f"
                                className="r-1oszu61 r-1xc7w19 r-1phboty r-1yadl64 r-deolkf r-6koalj r-eqz5dr r-crgep1 r-ifefl9 r-bcqeeo r-t60dpp r-bnwqim r-417010 r-1ro0kt6 r-16y2uox r-1wbh5a2"
                              >
                                <div
                                  data-rnwr700-1w6e6rj-1777fci="true"
                                ...
                                >
                                  <div
                                    data-slate-void="true"
                                    data-key="50107f61bb0f47f481329e7c9ca9a4b8"
                                  >
                                    <div>
                                      <div className="css-175oi2r r-1awozwy r-1ro0kt6 r-16y2uox r-1wbh5a2">
                                        <div
                                          className="css-175oi2r r-z2wwpe r-bnwqim style-iCBso"
                                          id="style-iCBso"
                                        >
                                          <div
                                            data-rnwi-5xr8s6-dse9kg-2fw26j-16zom3r-focus-visible="true"
                                            data-rnwi-handle="nearest"
                                            tabIndex={0}
                                            className="css-175oi2r r-1i6wzkk r-lrvibr r-1loqt21 r-1otgn73 r-1awozwy style-Z8AoD"
                                            id="style-Z8AoD"
                                          >
                                            <img
                                              alt=""
                                              loading="lazy"
                                              src="https://DinhMinh/landing/wp-content/uploads/2019/11/VNPAY_QR1.jpeg"
                                              width="100%"
                                              height="auto"
                                              decoding="async"
                                              className="r-z2wwpe r-dnmrzs"
                    ...
                    >
                      <div className="css-175oi2r r-1ro0kt6 r-16y2uox r-1wbh5a2">
                        <div className="css-175oi2r">
                          <div className="css-175oi2r">
                            <div
                              data-key="65effd0f5e0e413ebf2afbc015f2b95f"
                              className="view_manYY relative_F68jE column_C3yiR mediumVertical_-Vaii smallTop_crzBC smallBottom_BmSGf"
                            >
                              <div
                                data-block-content="65effd0f5e0e413ebf2afbc015f2b95f"
                                className="r-1oszu61 r-1xc7w19 r-1phboty r-1yadl64 r-deolkf r-6koalj r-eqz5dr r-crgep1 r-ifefl9 r-bcqeeo r-t60dpp r-bnwqim r-417010 r-1ro0kt6 r-16y2uox r-1wbh5a2"
                              >
                                <div
                                  dir="auto"
                                ...
                                >
                                  <div style={{ marginLeft: "30px" }}>
                                    <p><a style={{ fontWeight: "bold" }}>Bước 1: </a>Bộ phận Chăm Sóc Khách Hàng của Công ty sẽ tiếp nhận các khiếu nại của khách hàng.
                                      Bộ phận này chủ động giải quyết nhanh chóng và trả lời ngay kết quả giải quyết các khiếu nại trên cơ sở các Chính sách mà Công ty đã công bố.
                                    </p>
                                    <p><a style={{ fontWeight: "bold" }}>Bước 2: </a>Liên hệ với người phản ánh để xác minh lại thông tin phản ánh.
                                    </p>
                                    <p><a style={{ fontWeight: "bold" }}>Bước 3: </a>Liên hệ với bộ phận có trách nhiệm yêu cầu giải trình về sự việc gây tranh chấp.
                                    </p>
                                    <p><a style={{ fontWeight: "bold" }}>Bước 4: </a>Chuyển kết quả giải quyết khiếu nại cho các bộ phận có liên quan để thực hiện (Bộ phận Kế toán – Tài chính…)
                                      và gọi điện xác nhận với khách hàng về kết quả khiếu nại đã được giải quyết.
                                    </p>
                                  </div>
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  <div style={{ marginLeft: "30px" }}>
                                    <p>
                                     - Mọi tranh chấp phát sinh giữa Đình Minh và khách hàng sẽ được giải quyết trên cơ sở thương lượng.
                                      Trường hợp không đạt được thỏa thuận như mong muốn, một trong hai bên có quyền đưa vụ việc ra Tòa án kinh tế để giải quyết.
                                    </p>
                                  </div>
...
export default GiaiQuyetKhieuNai;
